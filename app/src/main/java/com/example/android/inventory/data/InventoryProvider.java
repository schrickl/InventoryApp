...
public class InventoryProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                // This will perform a query on the products table to return a
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String email = values.getAsString(ProductEntry.COLUMN_PRODUCT_SUPPLIER);
        if(email == null) {
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_PRICE)) {
            // Check that that the price is greater than or equal to 0
            Integer price = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_PRICE);
            if (price != null && price < 0) {
                throw new IllegalArgumentException("Product requires a valid price");
            }
        ...
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_SUPPLIER)) {
            ...
            if (email == null && !isValidEmail(email)) {
                throw new IllegalArgumentException("Supplier email requires a valid email");
            }
        }
        ...
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_PHOTO)) {
            ...
            if (photo == null) {
                throw new IllegalArgumentException("Product photo must not be null");
            }
        }
